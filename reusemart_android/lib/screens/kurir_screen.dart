...
class _KurirScreenState extends State<KurirScreen> {
  ...
  Future<void> _loadDataPesanan() async {
    ...
    final url = Uri.parse("http://10.0.2.2:8000/api/kurir/findKurir/$userId");
  ...
  Future<void> _loadDataHistory() async {
    ...
    final url = Uri.parse("http://10.0.2.2:8000/api/kurir/findKurirHistory/$userId");
  ...
  Future<void> _loadKurirDataFromBackend() async {
    ...
    final url = Uri.parse("http://10.0.2.2:8000/api/pegawai/showKurir/$userId");
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    final response = await http.post(
                      Uri.parse('http://10.0.2.2:8000/api/kurir/selesaiKurir/${item['ID_PEMBELIAN']}'),
