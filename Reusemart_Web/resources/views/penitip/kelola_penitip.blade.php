...
<head>
    ...
    <style>
        ...
        .container-fluid {
            max-width: 100vw; /* pastikan lebar penuh viewport */
            padding-left: 15px;
            padding-right: 15px;
        }
        ...
        th:nth-child(6), td:nth-child(6) { /* kolom alamat */
            min-width: 180px;
        }
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function fetchPenitipData(query = '') {
                ...
                data.forEach(p => {
                    ...
                    const row = `
                        <tr class="text-center">
                            ...
                            <td>
                                <a href="/kelola_penitip/edit/${p.ID_PENITIP}" class="btn btn-warning btn-sm mb-1">
                                    <i class="fa fa-edit"></i> Edit
                                </a>
                                <a href="/kelola_penitip/delete/${p.ID_PENITIP}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus penitip ini?')">
            ...
            .catch(error => {
                ...
                tableBody.innerHTML = '<tr><td colspan="7" class="text-center text-danger">Terjadi kesalahan saat mengambil data</td></tr>';
            });
        }
