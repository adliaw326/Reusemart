...
<head>
    ...
    <style>
        ...
        .nota {
            width: 100%; /* Mengubah lebar nota agar selebar halaman */
            margin: 20px auto;
            padding: 2px;
        ...
        .nota table {
            width: 100%; /* Membuat tabel selebar kolom */
            margin-top: 10px;
        ...
        .nota table th, .nota table td {
            padding: 10px; /* Menambah padding agar isi tabel lebih terlihat */
            text-align: center;
            border: 1px solid #000;
        }
...
<body>
    ...
    @foreach($transaksiPembelianByMonth as $month => $transaksi)
        <div class="nota">
            ...
            <p>Bulan: {{ $month }}</p>  <!-- Bulan dan Tahun -->
                ...
                <tbody>
                    ...
                    @foreach($transaksi as $transaksi)
                        @php
                            ...
                            // Membuat Kode Produk berdasarkan huruf pertama Nama Produk dan KODE_PRODUK
                            $kodeProduk = strtoupper(substr($produk->NAMA_PRODUK, 0, 1)) . $produk->KODE_PRODUK;

                            // Menambahkan nilai untuk total
